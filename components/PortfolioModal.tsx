...
const PortfolioModal: React.FC<PortfolioModalProps> = ({ artist, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-0 md:p-8 bg-black/90 backdrop-blur-sm animate-ink">
      <div className="bg-white w-full h-[100dvh] md:h-auto md:max-h-[90vh] overflow-hidden md:rounded-[2.5rem] flex flex-col relative">
        <button 
          onClick={onClose}
        ...
        <div className="flex flex-col md:flex-row h-full overflow-hidden">
          {/* Sidebar Info */}
          <div className="md:w-1/3 p-8 md:p-12 bg-gray-50 flex flex-col justify-between overflow-y-auto no-scrollbar">
          ...
          {/* Gallery Area */}
          <div className="md:w-2/3 overflow-y-auto p-6 md:p-12 space-y-8 no-scrollbar bg-white">
